...
class IQ_Option:
 ...
 # --------------------------------------------------------------------------
    ...
    def connect(self, sms_code=None):
        ...
        if check == True:
            self.user_id = global_value.user_id
...
# __________________FOR OPTION____________________________
    ...
    def buy(self, price, ACTIVES, ACTION, expirations):
        ...
        while self.api.result == None or id == None:
            try:
                if "message" in self.api.buy_multi_option[req_id].keys():
                    return False, self.api.buy_multi_option[req_id]["message"], None
            except:
                pass
            try:
                id = self.api.buy_multi_option[req_id]["id"]
        ...
        return self.api.result, self.api.buy_multi_option[req_id]["id"], self.api.buy_multi_option[req_id]["value"]
